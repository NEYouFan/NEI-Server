...
NEJ.define([
    ...
    _p._$crc32 = function (H) {
        function k(string) {
            ...
            for (var n = 0; n < string.length; n++) {
                ...
                if (c < 128) {
                    ...
                    F += String.fromCharCode((c >> 6) | 192);
                    F += String.fromCharCode((c & 63) | 128);
                } else {
                    F += String.fromCharCode((c >> 12) | 224);
                    F += String.fromCharCode(((c >> 6) & 63) | 128);
                    F += String.fromCharCode((c & 63) | 128);
                }
            }
            return F;
        ...
        var y = 0;
        crc = crc ^ (-1);
        for (var i = 0, t = H.length; i < t; i++) {
            y = (crc ^ H.charCodeAt(i)) & 0xFF;
